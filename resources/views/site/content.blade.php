                                    ...
                                    @foreach($clients as $client)
                                        <li>
                                            <a href="{{ $client->link }}" target="_blank">
                                                {!! Html::image('assets/img/' . $client->images, ' ') !!}
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="team_section clearfix">
                                ...
                                <div class="team_area">
                                    <div class="team_box wow fadeInDown delay-0{{ ($key * 3 + 3) }}s">
                                        ...
                                        <ul>
                                            <li><a href="{{ $person->twitter }}" target="_blank" class="fa fa-twitter"></a></li>
                                            <li><a href="{{ $person->facebook }}" target="_blank" class="fa fa-facebook"></a></li>
                                            <li><a href="{{ $person->vkontakte }}" target="_blank" class="fa fa-youtube"></a></li>
                                            <li><a href="{{ $person->instagram }}" target="_blank" class="fa fa-instagram"></a></li>
                                        </ul>
                                    </div>
                                    <h3 class="wow fadeInDown delay-0{{ ($key * 3 + 3) }}s">{{ $person->name }}</h3>
                                    <span class="wow fadeInDown delay-0{{ ($key * 3 + 3) }}s">{{ $person->position }}</span>
                                    <p class="wow fadeInDown delay-0{{ ($key * 3 + 3) }}s">{{ $person->text }}</p>
                                </div>
                                @endforeach
                            </div>
                        </div>
