<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Введите имя страницы, напр. contact']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('alias', 'Алиас страницы', ['class' => 'col-md-2 control-label']) !!}
        <div class="col-md-8">
            {!! Form::text('alias', old('alias'), ['class' => 'form-control', 'placeholder' => 'Введите алиас страницы, напр. contact']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('title', 'Заголовок страницы', ['class' => 'col-md-2 control-label']) !!}
        <div class="col-md-8">
            {!! Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => 'Введите заголовок страницы, напр. Контакты']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('text', 'Контент', ['class' => 'col-md-2 control-label']) !!}
        <div class="col-md-8">
            {!! Form::textarea('text', old('text'), ['id' => 'editor', 'class' => 'form-control', 'placeholder' => 'Введите контент']) !!}
        </div>
    </div>
    <div class="form-group">
